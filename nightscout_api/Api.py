...
class Api(object):
    ...
    def get_sgvs(self, params={}):
        ...
        r = requests.get(
            ...
            params=params,
            verify=False)
        return [models.SGV.new_from_json_dict(x) for x in r.json()]
    ...
    def get_treatments(self, params={}):
        ...
        r = requests.get(
            ...
            verify=False)
        if len(r.content) > 0:
            return [models.Treatment.new_from_json_dict(x) for x in r.json()]
        else:
            return []
    ...
    def get_profiles(self, params={}):
        ...
        r = requests.get(
            ...
            params=params,
            verify=False)
        return models.ProfileDefinitionSet.new_from_json_array(r.json())
